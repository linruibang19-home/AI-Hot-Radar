...
**状态**：✅ 2026-08-11 完成；验收记录见 `docs/archive/project-status.md` §0。
**读取**：`07-quality-security-ops.md`、`11-end-to-end-runbook.md`、
`12-delivery-index.md`、`docs/archive/project-status.md`。
...
`docs/status/evidence/rag-specialist-audit-20260811.md`。Planner 的 query-type 代理经扫描确认
在当前语料上不可操作，未用默认关闭的 LLM 结果冒充线上门禁通过。
**读取**：`04-rag-agent-design.md`、`07-quality-security-ops.md`、
`docs/archive/m4-rag-evaluation.md`、`data/golden/README.md`、
`docs/status/evidence/rag-product-readiness-20260810.md`。
...
`docs/status/evidence/rag-security-performance-20260811.md`。
**读取**：`04-rag-agent-design.md`、`07-quality-security-ops.md`、
`docs/status/evidence/rag-product-readiness-20260810.md`、ADR-0017、ADR-0023、ADR-0024。
...
`docs/status/evidence/rag-ui-polish-20260811.md`。
...
`docs/archive/handoff-20260811.md`。
**读取**：`README.md`、`12-delivery-index.md`、`docs/archive/project-status.md`、
`docs/archive/handoff-20260810.md` 以及 08-11 三份 RAG 验收记录。
...
`docs/status/evidence/report-reader-20260811.md`。
...
`docs/status/evidence/report-publication-20260811.md`。
...
**当前证据**：ADR-0026、Flyway V023、`docs/status/evidence/report-subscriptions-20260811.md`。
...
`11-end-to-end-runbook.md`、`docs/archive/m5-deployment.md`、
`docs/archive/m5-first-deploy-checklist.md`。
...
`docs/status/evidence/production-deployment-20260811.md`，当前交接见
`docs/archive/handoff-20260814.md`。
**读取**：`02-system-architecture.md`、`07-quality-security-ops.md`、
`11-end-to-end-runbook.md`、`docs/archive/m5-deployment.md`、
`docs/archive/m5-first-deploy-checklist.md`、TASK-M5-005 验收记录。
...
`docs/status/evidence/generation-model-selection-20260811.md`。
**读取**：`01-product-requirements.md`、`05-api-contract.md`、
...
**状态**：✅ 2026-08-11 完成；验收见
`docs/status/evidence/rag-operations-ui-20260811.md`。
...
**当前证据**：`docs/status/evidence/v016-selection-email-20260812.md`；生产当天 12 条精选已分布到
...
TASK-M5-009、`docs/archive/handoff-20260814.md`。
...
**当前证据**：`docs/status/evidence/portfolio-closeout-20260812.md`、`docs/interview/README.md`、
...
`11-end-to-end-runbook.md`、TASK-M5-010 与 `docs/archive/handoff-20260814.md`。
...
**当前证据**：`docs/status/evidence/portfolio-interview-completion-20260812.md`、
`docs/status/evidence/tencent-cloud-migration-readiness-20260812.md`、`docs/interview/README.md`。
...
项目健康检查通过。
**当前证据**：`docs/status/evidence/docker-storage-controls-20260812.md`。
...
**当前证据**：`docs/status/evidence/repository-hygiene-20260812.md`、`docs/code-map.md` 与
...
`docs/status/evidence/story-public-experience-20260813.md`。本卡只收口公开阅读体验，不重写聚类身份或算法。
...
**证据**：`docs/status/evidence/topic-timeline-performance-20260813.md`、
`docs/status/evidence/rag-corpus-audit-20260813.md`。
...
低风险发布验证，不是容量寻顶，详见 `docs/status/evidence/loadtest-m5-020-production-20260814.md`。
...
`docs/status/evidence/documentation-refresh-20260817.md`。
...
`docs/status/evidence/ci-actions-node24-20260817.md`。
...
`actions/setup-java@v4` 等版本弃用；继续依赖兼容垫片会让未来 Runner 更新时突然失效。
**产出**：把 checkout、Python、Java、Node 的官方 Action 升级到当前稳定主版本；显式关闭
setup-node 新增的 npm 自动缓存，保持既有无缓存语义；通过 pull request 重跑规格、Python、Java、
Flyway 与 Web 五路门禁，并保存日期化交付证据。
**边界**：不改变 Node 22、Python 3.12、Java 21、Maven、npm 或业务依赖版本；不升级 Docker
...
1. 补 [ADR-0032](../adr/0032-generation-provider-credentials-are-database-backed.md)，含放弃
   中转站方案的负结果；补交付证据
   [`model-console-release-20260819.md`](../status/evidence/model-console-release-20260819.md)；
...
7. 提交架构核查报告并挂进 `docs/status/README.md` 的索引。
