...
- 状态：**控制台部分已被 [ADR-0033](0033-generation-console-removed-model-stays-database-backed.md)
  取代（2026-08-29）**；数据库层与加密信封的设计仍然成立，下面的「中转站负结果」仍然有效
- 日期：2026-08-19
- 关联：ADR-0005、ADR-0027、ADR-0033、TASK-M5-030
