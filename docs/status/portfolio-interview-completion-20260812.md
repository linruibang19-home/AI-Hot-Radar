...
> **冻结快照**：本文记录 TASK-M5-011 当日的 00–10 文档结构。2026-08-13 起的完整实现手册、
> 00–12 面试课程与 120 题题库见 `docs/handbook/`、`docs/interview/` 和
> `documentation-audit-20260813.md`；不要用本文推断当前目录或测试数量。
