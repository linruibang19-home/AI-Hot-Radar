...
**叙述部分已合并为一份** [RAG 调优实验纪要](rag-tuning-log.md)：B1–B15、生成侧与延迟的
...
| 轮次 | JSON | 报告 | 结论 |
|---|---|---|---|
| B1 | `m4-rag-eval-B1-20260803.json` | [B1](rag-tuning-log.md) | 纯稠密基线 |
| B2 | `m4-rag-eval-B2-union-20260803.json`<br>`m4-rag-eval-B2-sparse-20260803.json` | [B2](rag-tuning-log.md) | **负结果**：并集比纯稠密还差 |
| B3 | `m4-rag-eval-B3-rrf-20260803.json` | [B3](rag-tuning-log.md) | RRF + 时间过滤 |
| B4 | `m4-rag-eval-B4-rerank40-20260803.json`<br>`m4-rag-eval-B4-rerank100-20260803.json` | [B4](rag-tuning-log.md) | 重排达标，40 候选优于 100 |
| B7 | `m4-rag-eval-B7-20260804.json` | [B7](rag-tuning-log.md) | 时效融合 |
| B8 | `m4-rag-eval-B8-incumbent-20260804.json`<br>`m4-rag-eval-B8-swept-20260804.json` | [B8](rag-tuning-log.md) | **负结果**：42 组权重，结论是不改 |
| B9 | `m4-rag-eval-B9-20260804.json` | [B9](rag-tuning-log.md) | directness / source_fit |
| B10 | `m4-rag-eval-B10-20260804.json` | [B10](rag-tuning-log.md) | entity_subject / repost |
...
| B15 | `m4-rag-eval-B15-20260809.json` | [B15](rag-tuning-log.md) | IDF + 实体加权在 ±0.02 噪声内，不能声称提升 |
...
| 轮次 | JSON | 报告 | 结论 |
|---|---|---|---|
| GEN（08-04） | `m4-rag-eval-GEN-20260804.json` | [GEN](rag-tuning-log.md) | 首次生成侧评测 |
...
| LAT | `m4-rag-eval-LAT-20260804.json` | [LAT](rag-tuning-log.md) | 99% 的延迟在三次外部往返 |
| GEN（08-09 门控） | `m4-rag-eval-GEN-20260809-gated.json` | [门控回归](rag-tuning-log.md) | 支持度达标率 0.9596，误拒率不变 |
| GEN（08-09 双口径） | `m4-rag-eval-GEN-20260809-dual.json` | [双口径说明](rag-tuning-log.md) | 段落级 0.9371；父块级 1.0000 是门控结果，不作独立判据 |
