...
> 截至：2026-08-17 CST。该快照不是实时承诺；动态状态以线上只读接口和目标机复核为准。
...
| 生产业务版本 | `v0.1.18@02e2d83b5f7794b0ee4f6fc4193a8ff6f0cfb935` |
...
2026-08-17 从香港生产 PostgreSQL 实查：
