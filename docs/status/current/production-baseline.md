...
> 截至：2026-08-31 CST（v0.1.21 部署后）。该快照不是实时承诺；动态状态以线上只读接口和目标机复核为准。
...
| 生产业务版本 | `v0.1.21@be31bd0c54da4c7e034da58b558980ae99b411ac` |
...
2026-08-31 从香港生产 PostgreSQL 实查：

| 指标 | 数值 |
|---|---:|
| 登记信源 / 允许调度 / 运行态 ACTIVE | 151 / 139 / 116 |
| 内容 | 4113 |
| active chunk / 已向量化 | 21504 / 21504 |
| Story | 3191 |
| RAG 问答 / 引用 | 237 / 1006 |
| 报告 | 37 |
