...
| **M1 真实信源与入库** | ✅ 完成 | 7 类适配器、90 源 ACTIVE、786 条内容入库、调度器 |
...
> **为什么 559 个事件里只有 7 个是多篇报道**：本语料以 GitHub Release 为主
...
- [x] 304 个测试（Python 270 + Java 22 + Web 12 + 类型检查），Python 部分断网可通过
...
| 11 条 Hugging Face Blog 标题带上了作者/相对时间/点赞数 | 同上，且污染 LLM prompt | 同一类选择器问题，需一并修 |
